...
const paintings = [
  {
    ...
    description: 'Бескрайние степи Забайкалья в лучах заходящего солнца',
    gradient: 'from-amber-300 via-orange-400 to-yellow-600',
  },
  {
    id: 2,
    title: 'Священные горы',
    description: 'Горные вершины, окутанные утренним туманом',
    gradient: 'from-slate-400 via-blue-300 to-sky-500',
  },
  {
    id: 3,
    title: 'Традиции предков',
    description: 'Сцена из традиционного бурятского праздника',
    gradient: 'from-red-400 via-orange-300 to-yellow-400',
  },
  {
    id: 4,
    title: 'Байкальские берега',
    description: 'Кристальные воды священного озера',
    gradient: 'from-cyan-400 via-blue-500 to-indigo-600',
  },
  {
    id: 5,
    title: 'Кочевники',
    description: 'Жизнь кочевых народов Забайкалья',
    gradient: 'from-emerald-400 via-teal-500 to-cyan-600',
  },
  {
    id: 6,
    title: 'Зимняя юрта',
    description: 'Традиционное жилище в заснеженной степи',
    gradient: 'from-gray-200 via-blue-100 to-white',
  },
]
